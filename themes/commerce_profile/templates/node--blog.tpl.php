...
hide($content['links']);
?>
<div class = "blog-page-title">BLOG</div>
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php if($display_submitted): ?>
    <footer<?php print $footer_attributes; ?>>
      <p class="author-datetime"><?php print $submitted . ' - '; ?>
        <span class="blog-comments-count"><?php print $comment_count . ' comments'?></span>
      </p>
    </footer>
  <?php endif; ?>
  ...
  <?php if (isset($content['comments']['comments'])) :?>
    <?php foreach ($content['comments']['comments'] as $comment) : ?>
      <?php if (isset($comment['links']['comment']['#links']['comment_forbidden'])) :?>
